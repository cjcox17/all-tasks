...
export const zh = {
  ...
  'card.source.apiHint': '此任务由脚本或程序通过 API 创建（不是看板新建），未经批准无法运行',
  'card.source.eventHint': '此任务由外部事件（Webhook）创建，未经批准无法运行',
  'card.approve': '批准',
  'card.run': '运行该任务',
  'new.workspace': '工作区',
  'new.mode': '模式',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'card.source.api': 'API',
  'card.source.event': 'Webhook',
  'card.source.apiHint': 'Created by a script or tool through the API (not the board dialog) — cannot run until approved',
  'card.source.eventHint': 'Created by an external event (webhook) — cannot run until approved',
