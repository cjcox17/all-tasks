 ...
 *
 * The `source` origin is recorded verbatim for transparency (the board shows
 * an API/Webhook badge on non-user tasks) but never changes the task's
 * approval state — creation does not gate anything.
