// Vendored from the dsh-web monorepo (zhu1090093659/dsh-web, shared/host/loopback.ts) at the dsh-task-board v0.3.6 fork point; kept as a plain source file here (no sync script in this repo).
/**
